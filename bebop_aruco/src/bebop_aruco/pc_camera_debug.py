...
class Debug:
    def __init__(self):
        ...
        self._ar = ARDetect()
        self._ar.set_params(self._ar_marker_size, self._ar_type, camera_matrix, distCoeffs)
        self._cv_bridge = CvBridge()
        self.dt = 1.0/ self._clock
        self._pub_img = rospy.Publisher(output_topic, Image, queue_size=1)
        self._pub_camera_info = rospy.Publisher(output_info_topic, CameraInfo, queue_size=1)
